...
class Robot {
 ...
 private:
  ...
  std::vector<std::string> auto_names{"Nothing", "StraightClimb", "BlueMidHuman", "BlueMidHumanClimb", "BlueRHuman", "BlueRHumanClimb", "RedRPlow", "RedLPlow","RedRShootClimb", "BlueLPlow", "BlueRPlowIntake", "BlueLDefensePrep", "Something"};
