...
class Robot {
 ...
 private:
  ...
  std::vector<std::string> auto_names{"Nothing", "StraightClimb", "BlueMidRHuman", "BlueMidRHumanClimb", "RedRPlow", "RedLPlow","RedRShootClimb", "BlueLPlow", "BlueRPlow", "Something"};
